...
public class StopwordFilter implements Filter {
	...
	private static Set<String> getStopwords() {
		String[] stopwords = new String[] {
				...
				"este", "fosse", "dele", "tu", "te", "vocês", "vos", "lhes", "meus", "minhas", "teu",
				...
				"houverei", "houverá", "houveremos", "houverão", "houveria", "houver�amos", "houveriam", "sou",
				...
				"serão", "seria", "seríamos", "seriam", "tenho", "tem", "temos", "têm", "tinha", "tínhamos", "tinham", "tive",
